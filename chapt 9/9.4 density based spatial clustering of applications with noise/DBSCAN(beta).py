...
class Dbscan:
    ...
    def draw(self):
        ...
        self.ax.plot([self.df.iloc[10]["density"], self.df.iloc[11]["density"]],
                     [self.df.iloc[10]["sugar"], self.df.iloc[11]["sugar"]],
